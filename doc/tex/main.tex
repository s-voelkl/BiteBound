...
\newcommand*{\IhreArbeit}{Project Mobile \& Ubiquitous Computing Summer Semester 2026: BiteBound}
\newcommand*{\IhreSchluesselwoerter}{ESP32-S3, Android, Node-RED, Arduino, IoT Game, MQTT, FreeRTOS, IMU}
...
\bibliography{references} % in case of reference error, run "bibtex main" first, then "pdflatex main" twice
