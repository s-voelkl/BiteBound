...
\begin{itemize}
    ...
    \item \texttt{index.js}: Acts as the script entry point, initializing the client-side uibuilder library and listening for active WebSocket updates from the flow.
\end{itemize}
