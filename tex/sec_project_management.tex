...
The BiteBound project was executed by a two-person team, with each member contributing to all aspects of the project by reviewing or leading the development of each component.
...
\begin{table}[htb]
	...
	\begin{tabularx}{\linewidth}{>{\raggedright\arraybackslash}p{2.6cm} >{\raggedright\arraybackslash}p{2.2cm} >{\raggedright\arraybackslash}X c c}
		...
		\midrule
		\multirow{3}{2.6cm}{\textbf{Milestone 1: Architecture \& Setup}}
		...
		\midrule
		\multirow{6}{2.6cm}{\textbf{Milestone 2: Hardware Implementation}}
		                   ...
		                   & Game Orchestration   & Orchestrated concurrency and game engine in Arduino.           & Lead              & Review               \\
		\midrule
		\multirow{3}{2.6cm}{\textbf{Milestone 3: UI \& Refinement}}
		...
		\midrule
		\multirow{1}{2.6cm}{\textbf{Milestone 4: Documentation}}
