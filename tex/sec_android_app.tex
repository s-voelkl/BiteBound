...
\begin{figure}[h]
    ...
    \begin{minipage}[b]{0.48\linewidth}
        \centering
        \includegraphics[width=0.8\linewidth]{../assets/android-app-2.png}
